...
static const struct isa_ext_data isa_edata_arr[] = {
    ...
    ISA_EXT_DATA_ENTRY(zca, true, PRIV_VERSION_1_10_0, ext_zca),
    ISA_EXT_DATA_ENTRY(zcb, true, PRIV_VERSION_1_10_0, ext_zcb),
    ISA_EXT_DATA_ENTRY(zcd, true, PRIV_VERSION_1_10_0, ext_zcd),
    ISA_EXT_DATA_ENTRY(zcf, true, PRIV_VERSION_1_10_0, ext_zcf),
#ifdef TARGET_CHERI
#if defined(TARGET_CHERI_RISCV_STD)
    ISA_EXT_DATA_ENTRY(zcherihybrid, true, PRIV_VERSION_1_10_0, ext_zyhybrid),
#ifdef TARGET_CHERI_RISCV_STD_093
    ISA_EXT_DATA_ENTRY(zcherilevels, true, PRIV_VERSION_1_10_0, ext_zylevels1),
#endif
#endif
    ISA_EXT_DATA_ENTRY(zcheripurecap, true, PRIV_VERSION_1_10_0, ext_cheri),
#if defined(TARGET_CHERI_RISCV_STD)
    ISA_EXT_DATA_ENTRY(zcheripte, true, PRIV_VERSION_1_10_0, cheri_pte),
#endif
#endif
...
static void riscv_cpu_reset_hold(Object *obj)
{
    ...
    env->menvcfg = (riscv_cpu_cfg_ext_svpbmt(&cpu->cfg) ? MENVCFG_PBMTE : 0) |
                   (cpu->cfg.ext_svadu ? MENVCFG_HADE : 0);
    env->henvcfg = (riscv_cpu_cfg_ext_svpbmt(&cpu->cfg) ? HENVCFG_PBMTE : 0) |
