...
static void disas_ldst_excl(DisasContext *s, uint32_t insn)
{
    ...
    case 0x1: /* STLXR */
        ...
        gen_store_exclusive(s, rs, rt, rt2, rn, size, false, rn != 31, false, true);
        return;
    ...
    case 0x5: /* LDAXR */
        ...
        gen_load_exclusive(s, rt, rt2, rn, size, false, rn != 31, false, true);
        if (is_lasr) {
    ...
    case 0x2: case 0x3: /* CASP / STXP */
        if (size & 2) { /* STXP / STLXP */
            ...
            gen_store_exclusive(s, rs, rt, rt2, rn, size, true, rn != 31, false, true);
            return;
        }
        if (rt2 == 31
            && ((rt | rs) & 1) == 0
    ...
    case 0x6: case 0x7: /* CASPA / LDXP */
        if (size & 2) { /* LDXP / LDAXP */
            ...
            gen_load_exclusive(s, rt, rt2, rn, size, true, rn != 31, false, true);
            if (is_lasr) {
                tcg_gen_mb(TCG_MO_ALL | TCG_BAR_LDAQ);
            }
            return;
...
static void disas_ld_lit(DisasContext *s, uint32_t insn)
{
    ...
    gen_pc_plus_diff(s, dirty_addr, imm);
                                ...
                                bool is_vector)
{
    ...
    clean_addr = gen_mte_and_cheri_check1_mmuidx(
        s, dirty_addr, !is_store, is_store, writeback || rn != 31, memop,
                              ...
                              int size, int rt, bool is_vector)
{
    ...
    clean_addr = gen_mte_and_cheri_check1(s, cpu_reg_sp(s, rn), true, o3_opc != 014,
                                          rn != 31, mop, rn, false, true);
                           ...
                           int size, int rt, bool is_vector)
{
    ...
    clean_addr =
        gen_mte_and_cheri_check1(s, dirty_addr, true, false,
                                 is_wback || rn != 31, memop, rn, false, true);
